...
load('/home/arianasp/baboons/data/matlab_processed/individual_level_metrics/speeds_step_1_level1.mat')
...
for i = 1:length(threshes)
    ...
    save('/home/arianasp/baboons/output/max_ent/baboon_ising_fits_by_speed_thresh_step1.mat','fits')
